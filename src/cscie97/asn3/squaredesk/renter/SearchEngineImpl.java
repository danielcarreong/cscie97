...
public class SearchEngineImpl implements SearchEngine {
    ...
    /* (non-Javadoc)
     * @see cscie97.asn3.squaredesk.renter.SearchEngine#searchByFeature(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cscie97.asn3.squaredesk.renter.SearchEngine#searchByLocation(double, double)
     */
    @Override
    public OfficeSpace searchByLocation(OfficeSpace officeSpace) throws SearchEngineException {
	String lat = String.valueOf(officeSpace.getLocation().getLat());
	String lon = String.valueOf(officeSpace.getLocation().getLon());
    ...
    /* (non-Javadoc)
     * @see cscie97.asn3.squaredesk.renter.SearchEngine#searchByFacilityCategory(java.lang.String)
     */
    @Override
    public OfficeSpace searchByFacilityCategory(OfficeSpace officeSpace) throws SearchEngineException {
	if (officeSpace.getFacility() != null) {
	    String facility = officeSpace.getFacility().getType().toString();
     ...
     */
    @Override
    public OfficeSpace searchByRate(OfficeSpace officeSpace) throws SearchEngineException {
	// TODO Auto-generated method stub
	return null;
    }

    /* (non-Javadoc)
     * @see cscie97.asn3.squaredesk.renter.SearchEngine#searchByDate(java.util.Date, java.util.Date)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cscie97.asn3.squaredesk.renter.SearchEngine#searchByCommonAccess(cscie97.asn2.sharedesk.provider.OfficeSpace)
     */
    @Override
