...
/**
 * Class defining Scheduling services, which contain creation and deletion of Booking instances.
 * Also checks the availability of an OfficeSpace, retrieves a Booking instance if exists and a List of Booking instances.
...
public interface SchedulingService {
    ...
    /**
     * Retrieves a list of all Bookings made up to the point of making this request. 
     * @return List<Booking>
     */
